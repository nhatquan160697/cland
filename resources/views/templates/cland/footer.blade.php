<section id="footer_bottom_area">
		...
		<script type="text/javascript" src="/templates/cland/js/jquery.tooltipster.min.js"></script>		
		<script type="text/javascript">
			$(document).ready(function() {
				$('.tooltip').tooltipster();
			});
		</script>
		 <script type="text/javascript" src="/templates/cland/js/selectnav.min.js"></script>
		<script type="text/javascript">
			selectnav('nav', {
			  label: '-Navigation-',
			  nested: true,
		...
		<script src="/templates/cland/js/pgwslider.js"></script>
		<script type="text/javascript">
			$(document).ready(function() {
				$('.pgwSlider').pgwSlider({
		...
		<script type="text/javascript" src="/templates/cland/js/placeholder_support_IE.js"></script>
	</body>
</html>
